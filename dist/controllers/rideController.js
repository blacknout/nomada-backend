...
exports.deleteRideRoute = exports.getRideRoute = exports.saveRideRoute = exports.deleteRide = exports.getRideDetails = exports.updateRide = exports.createRide = void 0;
...
const createRide = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const newRide = yield Ride_1.Ride.create({
            groupId,
            createdBy,
            roadCaptainId,
            startLocation,
...
const updateRide = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const ride = yield Ride_1.Ride.findByPk(rideId);
        if (!ride) {
        ...
        if (ride.createdBy === req.user.id || ride.roadCaptainId === req.user.id) {
            ...
            if (roadCaptainId)
                ride.roadCaptainId = roadCaptainId;
            if (status)
                ride.status = status;
            yield ride.save();
...
const getRideDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const ride = yield Ride_1.Ride.findByPk(rideId, {
            include: [
                { model: Group_1.Group, as: "group" },
                { model: User_1.User, as: "creator", attributes: ["id", "username"] },
                { model: User_1.User, as: "roadCaptain", attributes: ["id", "username"] },
            ],
        });
        if (!ride) {
            res.status(404).json({ message: "Ride not found" });
...
const deleteRide = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const ride = yield Ride_1.Ride.findByPk(rideId, {
            include: [{ model: Group_1.Group, as: "group" }],
        });
        if (!ride) {
            res.status(404).json({ message: "Ride not found" });
        }
 ...
 * }
 */
const saveRideRoute = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { rideId } = req.params;
...
exports.saveRideRoute = saveRideRoute;
/**
 * @typedef {Object} Location
 * @property {number} latitude - The latitude of the GPS point.
 * @property {number} longitude - The longitude of the GPS point.
 ...
 * }
 */
const getRideRoute = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { rideId } = req.params;
        const ride = yield Ride_1.Ride.findByPk(rideId, {
            attributes: ["id", "route"],
...
exports.getRideRoute = getRideRoute;
/**
 * @typedef {Object} SuccessResponse
 * @property {string} message - The success message.
 */
 ...
 * }
 */
const deleteRideRoute = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { rideId } = req.params;
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
...
exports.deleteRideRoute = deleteRideRoute;
