 ...
 */
router.post("/", auth_1.authenticateUser, rideValidation_1.validateRideInfo, rideController_1.createRide);
/**
 * @swagger
 * /rides/{rideId}:
 *   patch:
 ...
 *         description: Internal server error
 */
router.put("/:rideId", auth_1.authenticateUser, rideValidation_1.validateRideQuery, rideValidation_1.validateRideInfo, rideController_1.updateRide);
/**
 * @swagger
 * /ride/{rideId}:
 *   get:
 ...
 */
router.get("/:rideId", auth_1.authenticateUser, rideValidation_1.validateRideQuery, rideController_1.getRideDetails);
/**
 * @swagger
 * /ride/{rideId}:
 *   delete:
 ...
 */
router.delete("/:rideId", auth_1.authenticateUser, rideValidation_1.validateRideQuery, rideController_1.deleteRide);
/**
 * @swagger
 * /route/{rideId}:
 *   post:
 ...
 *                   example: "Server error."
 */
router.post("/route/:rideId", auth_1.authenticateUser, rideValidation_1.validateRideQuery, rideController_1.saveRideRoute);
/**
 * @swagger
 * /ride/{rideId}:
 *   get:
 ...
 *                   example: "Server error."
 */
router.get("/route/:rideId", auth_1.authenticateUser, rideValidation_1.validateRideQuery, rideController_1.getRideRoute);
/**
 * @swagger
 * /ride/{rideId}:
 *   delete:
 ...
 *                   example: "Server error."
 */
router.delete("/route/:rideId", auth_1.authenticateUser, rideValidation_1.validateRideQuery, rideController_1.deleteRideRoute);
