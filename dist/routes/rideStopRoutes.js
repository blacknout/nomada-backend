...
const rideStopController_1 = require("../controllers/rideStopController");
const rideStopValidation_1 = require("../middleware/rideStopValidation");
const rideValidation_1 = require("../middleware/rideValidation");
 ...
 */
router.post("/:rideId", auth_1.authenticateUser, rideValidation_1.validateRideQuery, rideStopValidation_1.validateRideStopInfo, rideStopController_1.createRideStop);
/**
 * @swagger
 * /stop/stopId:
 *   put:
 ...
 *                   example: "Server error."
 */
router.put("/:stopId", auth_1.authenticateUser, rideStopValidation_1.validateStopQuery, rideStopValidation_1.validateRideStopInfo, rideStopController_1.updateRideStop);
/**
 * @swagger
 * /{stopId}:
 *   get:
 ...
 *                   example: "Server error."
 */
router.get("/:stopId", auth_1.authenticateUser, rideStopValidation_1.validateStopQuery, rideStopController_1.getRideStop);
/**
 * @swagger
 * /ride/{rideId}:
 *   get:
 ...
 *                   example: "Server error."
 */
router.get("/ride/:rideId", auth_1.authenticateUser, rideValidation_1.validateRideQuery, rideStopController_1.getAllRideStops);
/**
 * @swagger
 * /stop/{stopId}:
 *   patch:
 ...
 *                   example: "Server error."
 */
router.patch("/:stopId", auth_1.authenticateUser, rideStopValidation_1.validateStopQuery, rideStopController_1.resolveRideStop);
/**
 * @swagger
 * /stop/{stopId}:
 *   delete:
 ...
 *                   example: "Server error."
 */
router.delete("/:stopId", auth_1.authenticateUser, rideStopValidation_1.validateStopQuery, rideStopController_1.deleteRideStop);
